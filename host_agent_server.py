...
def create_and_run_host(
    ...
    configure(
        service_name="SprintStatusAgentTracing",
        service_namespace="SprintStatusAgent",
    )
...
class GenericAgentHost:
    ...
    def _setup_handlers(self):
        ...
        async def on_installation_update(context: TurnContext, _: TurnState):
            ...
            if action == "add":
                await context.send_activity(
                    "👋 Thanks for adding me! I'm the Sprint Status Intelligence Agent. "
                    "Ask me about your team's activity, blockers, decisions, and action items. "
                    "Type /help for more info."
                )
            elif action == "remove":
                await context.send_activity("👋 Thanks for your time! Good luck with your sprints.")
